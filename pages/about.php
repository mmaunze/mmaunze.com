...
<!-- Hero Section -->
<section class="hero" style="padding: var(--spacing-2xl) 0; background-color: var(--bg-white);">
  <div class="container">
    <h6 style="color: var(--primary); margin-bottom: var(--spacing-sm);">SOBRE MIM</h6>
    <h1 style="margin-bottom: var(--spacing-sm);">Conhece o profissional por trás das soluções tecnológicas</h1>
    <p style="max-width: 700px; margin: 0 auto;">Transformando desafios em oportunidades através da tecnologia</p>
  </div>
</section>
...
<section style="background-color: var(--bg-light); padding: var(--spacing-2xl) 0;">
  <div class="container">
    <div style="display: grid; grid-template-columns: 1.5fr 1fr; gap: var(--spacing-2xl); align-items: start;">
      ...
      <div class="card" style="background-color: var(--primary); color: white; text-align: center; padding: var(--spacing-xl);">
        <div style="width: 120px; height: 120px; background-color: rgba(255, 255, 255, 0.2); border-radius: 50%; margin: 0 auto var(--spacing-lg); display: flex; align-items: center; justify-content: center; font-size: 3rem; font-weight: 700;">MM</div>
        <h3 style="color: white; margin-bottom: var(--spacing-sm);">Meldo Maúnze</h3>
        <p style="color: rgba(255, 255, 255, 0.9); margin-bottom: var(--spacing-xs);">Desenvolvedor Full Stack</p>
...
<section style="background-color: var(--bg-white); padding: var(--spacing-2xl) 0;">
  <div class="container">
    <h6 style="color: var(--primary); text-align: center; margin-bottom: var(--spacing-sm);">MINHA JORNADA</h6>
    <h2 style="text-align: center; margin-bottom: var(--spacing-xl);">Experiência em Números</h2>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: var(--spacing-lg);">
      ...
      <div style="text-align: center; padding: var(--spacing-lg); border: 2px solid var(--bg-light);">
        <h3 style="color: var(--secondary); font-size: 3rem; margin-bottom: var(--spacing-sm);">50+</h3>
        <p style="font-weight: 600; color: var(--text-dark); margin: 0;">Projectos Concluídos</p>
      </div>
      
      <div style="text-align: center; padding: var(--spacing-lg); border: 2px solid var(--bg-light);">
        <h3 style="color: var(--success); font-size: 3rem; margin-bottom: var(--spacing-sm);">100+</h3>
        <p style="font-weight: 600; color: var(--text-dark); margin: 0;">Clientes Satisfeitos</p>
      </div>
      
      <div style="text-align: center; padding: var(--spacing-lg); border: 2px solid var(--bg-light);">
        <h3 style="color: var(--primary); font-size: 3rem; margin-bottom: var(--spacing-sm);">4321+</h3>
        <p style="font-weight: 600; color: var(--text-dark); margin: 0;">Horas de Código</p>
      </div>
    </div>
  </div>
</section>
...
<section style="background-color: var(--bg-light); padding: var(--spacing-2xl) 0;">
  <div class="container">
    <h6 style="color: var(--primary); text-align: center; margin-bottom: var(--spacing-sm);">TECNOLOGIAS</h6>
    <h2 style="text-align: center; margin-bottom: var(--spacing-md);">Competências e Tecnologias</h2>
    ...
    <div class="grid grid-2" style="margin-top: var(--spacing-xl);">
      <div class="card" style="border: 4px solid var(--primary);">
        ...
        <div>
          <span class="badge" style="background-color: var(--bg-light);">Frontend</span>
          <span class="badge" style="background-color: var(--bg-light);">Backend</span>
          <span class="badge" style="background-color: var(--bg-light);">Full Stack</span>
        </div>
      </div>
      ...
      <div class="card" style="border: 4px solid var(--secondary);">
        ...
        <div>
          <span class="badge" style="background-color: var(--bg-light);">iOS</span>
          <span class="badge" style="background-color: var(--bg-light);">Android</span>
          <span class="badge" style="background-color: var(--bg-light);">Cross-platform</span>
        </div>
      </div>
      ...
      <div class="card" style="border: 4px solid var(--primary);">
        ...
        <div>
          <span class="badge" style="background-color: var(--bg-light);">Cloud</span>
          <span class="badge" style="background-color: var(--bg-light);">DevOps</span>
          <span class="badge" style="background-color: var(--bg-light);">Infrastructure</span>
        </div>
      </div>
      ...
      <div class="card" style="border: 4px solid var(--secondary);">
        ...
        <div>
          <span class="badge" style="background-color: var(--bg-light);">ML</span>
          <span class="badge" style="background-color: var(--bg-light);">AI</span>
          <span class="badge" style="background-color: var(--bg-light);">Data Science</span>
        </div>
      </div>
      ...
      <div class="card" style="border: 4px solid var(--primary);">
        ...
        <div>
          <span class="badge" style="background-color: var(--bg-light);">SQL</span>
          <span class="badge" style="background-color: var(--bg-light);">NoSQL</span>
          <span class="badge" style="background-color: var(--bg-light);">Cache</span>
        </div>
      </div>
      ...
      <div class="card" style="border: 4px solid var(--secondary);">
        ...
        <div>
          <span class="badge" style="background-color: var(--bg-light);">Security</span>
          <span class="badge" style="background-color: var(--bg-light);">Networks</span>
          <span class="badge" style="background-color: var(--bg-light);">Compliance</span>
        </div>
      </div>
    </div>
  </div>
...
<!-- CTA -->
<section style="background-color: var(--primary); color: white; text-align: center; padding: var(--spacing-2xl) 0;">
  <div class="container">
