      ...
      <div class="row gy-6 gy-lg-0">
        ...
        <div class="col-lg-12 mb-3">
          ...
          <div class="container mt-4">
            ...
            <h3 class="card-title text-center text-primary mb-4">Sistema de Gestão Escolar</h3>
            <p class="card-text">
              ...
              <div class="col-12 col-md-6 col-lg-4">
                <ul class="list-group">
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-primary rounded-pill">Framework principal para a API</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>JPA/Hibernate:</strong>
                    <span class="badge bg-secondary rounded-pill">Gerenciamento de base de dados</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Spring Security:</strong>
                    <span class="badge bg-success rounded-pill">Autenticação e autorização</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>JWT:</strong>
                    <span class="badge bg-danger rounded-pill">Gerenciamento de tokens de segurança</span>
                  </li>
                </ul>
              </div>
              <div class="col-12 col-md-6 col-lg-4">
                <ul class="list-group">
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>MySQL:</strong>
                    <span class="badge bg-info rounded-pill">Base de dados relacional</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Maven:</strong>
                    <span class="badge bg-warning rounded-pill">Gerenciamento de dependências</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Swagger:</strong>
                    <span class="badge bg-light text-dark rounded-pill">Documentação da API</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Vue.js:</strong>
                    <span class="badge bg-dark text-light rounded-pill">Framework principal para o frontend</span>
                  </li>
                </ul>
              </div>
              <div class="col-12 col-md-6 col-lg-4">
                <ul class="list-group">
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-primary rounded-pill">Gerenciamento de rotas no frontend</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Vuex:</strong>
                    <span class="badge bg-secondary rounded-pill">Gerenciamento de estado</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Axios:</strong>
                    <span class="badge bg-info rounded-pill">Requisições HTTP entre frontend e backend</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center">
                    <strong>Vuetify:</strong>
                    <span class="badge bg-success rounded-pill">Framework de componentes para UI</span>
                  </li>
                </ul>
              </div>
            </div>
