...
<body>
    ...
    <div class="authentication-inner row m-0">
      ...
      <div
        ...
        <div class="w-px-400 mx-auto pt-5 pt-lg-0">
          ...
          <p id="resultado" class="mb-5">Please sign-in to your account and start the adventure</p>

          <form id="formAuthentication" class="mb-5" onsubmit="login()" method="POST">
  ...
  <script src="../assets/vendor/libs/jquery/jquery.js" charset="utf-8"></script>
  <script>
    function login() {
      var email = $("#email").val();
